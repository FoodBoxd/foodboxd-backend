    ...
    public static class DataSeeder
    {
        ...
        private static void SeedDishesRecipes(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<Dish>().HasData(
                ...
                new Dish { DishId = 11, Name = "Creme Brûlée", Description = "Sobremesa clássica francesa com creme aveludado e cobertura crocante de açúcar queimado.", Photo = "https://res.cloudinary.com/djwfw75pg/image/upload/v1762812018/creme_brule_g2bdne.png" },
                new Dish { DishId = 12, Name = "Tabule", Description = "Salada leve do Oriente Médio, à base de trigo para quibe (bulgur), ervas frescas, tomate e limão.", Photo = "https://res.cloudinary.com/djwfw75pg/image/upload/v1762811987/tabule_sxcrcx.png" },
                new Dish { DishId = 13, Name = "Panqueca de Banana", Description = "Panquecas fofas de banana, simples e reconfortantes, servidas com manteiga ou mel.", Photo = "https://res.cloudinary.com/djwfw75pg/image/upload/v1762812098/panqueca_banana_lppavr.png" },
                new Dish { DishId = 14, Name = "Moqueca de Peixe", Description = "Ensopado brasileiro de peixe cozido em leite de coco, tomate, cebola e coentro.", Photo = "https://res.cloudinary.com/djwfw75pg/image/upload/v1762812097/moqueca_tniuew.png" },
                new Dish { DishId = 15, Name = "Brigadeiro", Description = "Doce brasileiro cremoso à base de leite condensado e chocolate, enrolado em bolinhas cobertas com granulado.", Photo = "https://res.cloudinary.com/djwfw75pg/image/upload/v1762812011/brigadeiro_vfwxga.png" },
                new Dish { DishId = 16, Name = "Bobó de Camarão", Description = "Ensopado cremoso brasileiro feito com camarão, mandioca e leite de coco, aromatizado com coentro.", Photo = "https://res.cloudinary.com/djwfw75pg/image/upload/v1762812010/bobo_camarao_ghwhar.png" },
                new Dish { DishId = 17, Name = "Quiche Lorraine", Description = "Torta salgada francesa recheada com bacon, queijo e creme, de textura firme e sabor levemente amanteigado.", Photo = "https://res.cloudinary.com/djwfw75pg/image/upload/v1762811981/quiche_ewbzts.png" },
                new Dish { DishId = 18, Name = "Pão de Alho e Ervas", Description = "Pão crocante coberto por uma mistura aromática de manteiga, alho e ervas, perfeito como acompanhamento para churrascos.", Photo = "https://res.cloudinary.com/djwfw75pg/image/upload/v1762812099/pao_de_alho_ervas_ny5sht.png" },
                new Dish { DishId = 19, Name = "Ceviche de Salmão", Description = "Prato refrescante de origem peruana: cubos de salmão marinados em limão com cebola, coentro e pimenta.", Photo = "https://res.cloudinary.com/djwfw75pg/image/upload/v1762812016/ceviche_salmao_k9gh8k.png" },
                new Dish { DishId = 20, Name = "Pavê de Chocolate", Description = "Sobremesa em camadas com biscoito, creme de chocolate e leite condensado, servida gelada.", Photo = "https://res.cloudinary.com/djwfw75pg/image/upload/v1762812115/pave_lmljsj.png" },
                new Dish { DishId = 21, Name = "Feijoada", Description = "Prato tradicional brasileiro à base de feijão preto, carnes salgadas e acompanhamentos como arroz e farofa.", Photo = "https://res.cloudinary.com/djwfw75pg/image/upload/v1762812024/feijoada_iaowd4.png" },
                new Dish { DishId = 22, Name = "Acarajé", Description = "Bolinho frito de feijão-fradinho recheado com vatapá e camarão, típico da culinária baiana.", Photo = "https://res.cloudinary.com/djwfw75pg/image/upload/v1762812002/acaraje_ykab95.png" },
                new Dish { DishId = 23, Name = "Vatapá", Description = "Creme rico e aromático à base de pão, camarão, leite de coco, azeite de dendê e amendoim, servido com arroz ou acarajé.", Photo = "https://res.cloudinary.com/djwfw75pg/image/upload/v1762811992/vatapa_ascc8f.png" },
                new Dish { DishId = 24, Name = "Arroz Carreteiro", Description = "Prato rural de arroz com carne seca e linguiça, saboroso e pronto para aproveitar sobras de carne.", Photo = "https://res.cloudinary.com/djwfw75pg/image/upload/v1762812003/arroz_carreteiro_bujrbq.png" },
                new Dish { DishId = 25, Name = "Baião de Dois", Description = "Clássico nordestino que combina arroz e feijão de corda com queijo coalho e temperos, cremoso e nutritivo.", Photo = "https://res.cloudinary.com/djwfw75pg/image/upload/v1762812003/baiao_dois_xn4pcz.png" },
                new Dish { DishId = 26, Name = "Escondidinho de Carne Seca", Description = "Purê de mandioca cobrindo um recheio suculento de carne seca desfiada, gratinado com queijo.", Photo = "https://res.cloudinary.com/djwfw75pg/image/upload/v1762812023/escondidinho_cseca_fbm1ml.png" },
                new Dish { DishId = 27, Name = "Picanha Assada", Description = "Peça nobre do churrasco brasileiro, temperada e assada até formar crosta dourada e suculenta por dentro.", Photo = "https://res.cloudinary.com/djwfw75pg/image/upload/v1762812113/picanha_wgubmf.png" },
                new Dish { DishId = 28, Name = "Pastel de Feira", Description = "Salgado frito recheado (carne, queijo ou outros), crocante por fora e muito popular em feiras e lanchonetes.", Photo = "https://res.cloudinary.com/djwfw75pg/image/upload/v1762812112/pastel_rcbdek.png" },
                new Dish { DishId = 29, Name = "Coxinha", Description = "Salgadinho de massa de farinha recheado com frango desfiado, empanado e frito até ficar dourado.", Photo = "https://res.cloudinary.com/djwfw75pg/image/upload/v1762812018/coxinha_zx3ruj.png" },
                new Dish { DishId = 30, Name = "Canjica", Description = "Sobremesa cremosa feita com milho branco, leite de coco, leite condensado e canela, servida gelada ou morna.", Photo = "https://res.cloudinary.com/djwfw75pg/image/upload/v1762812016/canjica_fmaicy.png" },
                new Dish { DishId = 31, Name = "Pad Thai", Description = "Clássico prato de macarrão tailandês, sabor agridoce com amendoim e limão.", Photo = "https://res.cloudinary.com/djwfw75pg/image/upload/v1762812097/pad_tai_fcf2yz.png" },
                new Dish { DishId = 32, Name = "Ramen", Description = "Sopa japonesa reconfortante com caldo aromático, noodles e toppings variados.", Photo = "https://res.cloudinary.com/djwfw75pg/image/upload/v1762811981/ramen_znugjq.png" },
                new Dish { DishId = 33, Name = "Frango General Tso", Description = "Prato chinês apimentado e agridoce com pedaços de frango empanados e molho caramelizado.", Photo = "https://res.cloudinary.com/djwfw75pg/image/upload/v1762812058/frango_general_tso_w7g7kj.png" },
                new Dish { DishId = 34, Name = "Gyoza", Description = "Pastelzinho japonês recheado, levemente dourado e servido com molho shoyu.", Photo = "https://res.cloudinary.com/djwfw75pg/image/upload/v1762812058/guioza_ykbekx.png" },
                new Dish { DishId = 35, Name = "Bibimbap", Description = "Prato coreano colorido com arroz, legumes, carne e ovo, servido com óleo de gergelim.", Photo = "https://res.cloudinary.com/djwfw75pg/image/upload/v1762812009/bibimbap_z582k4.png" },
                new Dish { DishId = 36, Name = "Curry Verde Tailandês", Description = "Curry aromático com leite de coco, ervas e pimenta, geralmente servido com arroz.", Photo = "https://res.cloudinary.com/djwfw75pg/image/upload/v1762812023/curry_verde_r8gytm.png" },
                new Dish { DishId = 37, Name = "Frango Teriyaki", Description = "Peito de frango glaceado em molho teriyaki, levemente adocicado e brilhante.", Photo = "https://res.cloudinary.com/djwfw75pg/image/upload/v1762812062/frango_teriyaki_rgw3cc.png" },
                new Dish { DishId = 38, Name = "Frango Manteiga (Butter Chicken)", Description = "Receita indiana cremosa com molho à base de tomate, especiarias e manteiga.", Photo = "https://res.cloudinary.com/djwfw75pg/image/upload/v1762812016/butter_chicken_rdtyvh.png" },
                new Dish { DishId = 39, Name = "Mapo Tofu", Description = "Prato picante chinês com tofu macio e carne em molho apimentado e aromático.", Photo = "https://res.cloudinary.com/djwfw75pg/image/upload/v1762812097/mapo_tofu_exvjcf.png" },
                new Dish { DishId = 40, Name = "Bulgogi", Description = "Carne bovina marinada e grelhada no estilo coreano, saborosa e levemente adocicada.", Photo = "https://res.cloudinary.com/djwfw75pg/image/upload/v1762812011/bulgogi_o9os4l.png" },
                new Dish { DishId = 41, Name = "Beef Bourguignon", Description = "Ensopado francês de carne cozida lentamente em vinho tinto, com bacon, cebolas e ervas.", Photo = "https://res.cloudinary.com/djwfw75pg/image/upload/v1762812009/beef_bouguignon_zeme2m.png" },
                new Dish { DishId = 42, Name = "Tiramisù", Description = "Sobremesa italiana clássica feita com camadas de biscoito embebido em café, creme de mascarpone e cacau.", Photo = "https://res.cloudinary.com/djwfw75pg/image/upload/v1762811989/tiramisu_uai6ky.png" },
                new Dish { DishId = 43, Name = "Pasta Puttanesca", Description = "Massa italiana com molho robusto de tomate, azeitonas, alcaparras e alho.", Photo = "https://res.cloudinary.com/djwfw75pg/image/upload/v1762811981/putanesca_nnwv8y.png" },
                new Dish { DishId = 44, Name = "Paella Valenciana", Description = "Ícone espanhol de arroz com frutos do mar, açafrão e pimentões, cozido em uma panela larga.", Photo = "https://res.cloudinary.com/djwfw75pg/image/upload/v1762812098/paella_wrjle9.png" },
                new Dish { DishId = 45, Name = "Moussaka", Description = "Assado grego em camadas de berinjela, carne temperada e molho cremoso, gratinado com queijo.", Photo = "https://res.cloudinary.com/djwfw75pg/image/upload/v1762812097/moussaka_fss565.png" },
                new Dish { DishId = 46, Name = "Gnocchi de Batata", Description = "Nhoques leves feitos com batata e farinha, servidos com manteiga ou molho de sua preferência.", Photo = "https://res.cloudinary.com/djwfw75pg/image/upload/v1762812059/gnocci_gvsoac.png" },
                new Dish { DishId = 47, Name = "Ratatouille", Description = "Guarnição francesa de legumes (berinjela, pimentão, tomate) lentamente cozidos com ervas.", Photo = "https://res.cloudinary.com/djwfw75pg/image/upload/v1762811982/ratatouille_v2_tdn9at.png" },
                new Dish { DishId = 48, Name = "Bruschetta al Pomodoro", Description = "Entrada italiana simples: pão tostado com tomate fresco, alho e manjericão.", Photo = "https://res.cloudinary.com/djwfw75pg/image/upload/v1762812011/bruschetta_ry0qsy.png" },
                new Dish { DishId = 49, Name = "Bouillabaisse", Description = "Sopa de peixe tradicional de Marselha, rica em sabores do mar e temperos como açafrão.", Photo = "https://res.cloudinary.com/djwfw75pg/image/upload/v1762812010/bouillabaisse_i3sm9i.png" },
                new Dish { DishId = 50, Name = "Risotto alla Milanese", Description = "Risoto italiano aromatizado com açafrão, cremoso e finalizado com queijo parmesão.", Photo = "https://res.cloudinary.com/djwfw75pg/image/upload/v1762811983/risotto_milanese_tglurr.png" },
                new Dish { DishId = 51, Name = "Tarte Tatin", Description = "Torta invertida de maçã caramelizada, servida quente com crosta amanteigada.", Photo = "https://res.cloudinary.com/djwfw75pg/image/upload/v1762811989/tarte_tatin_itdflk.png" },
                new Dish { DishId = 52, Name = "Panna Cotta", Description = "Sobremesa italiana cremosa feita com creme de leite, açúcar e gelatina, aromatizada com baunilha.", Photo = "https://res.cloudinary.com/djwfw75pg/image/upload/v1762812098/pannacota_kcybkf.png" },
                new Dish { DishId = 53, Name = "New York Cheesecake", Description = "Cheesecake clássico com base de biscoito e recheio cremoso de cream cheese.", Photo = "https://res.cloudinary.com/djwfw75pg/image/upload/v1762812017/cheesecake_fp28cw.png" },
                new Dish { DishId = 54, Name = "Pavlova de Frutas Vermelhas", Description = "Merengue crocante por fora e macio por dentro, servido com chantilly e frutas vermelhas.", Photo = "https://res.cloudinary.com/djwfw75pg/image/upload/v1762812112/pavlova_iavxig.png" },
                new Dish { DishId = 55, Name = "Apple Pie", Description = "Torta de maçã tradicional com massa amanteigada e recheio levemente caramelizado.", Photo = "https://res.cloudinary.com/djwfw75pg/image/upload/v1762812003/apple_pie_zza3ji.png" },
                new Dish { DishId = 56, Name = "Profiteroles com Chocolate", Description = "Bolinh0s de massa choux recheados, servidos com molho quente de chocolate.", Photo = "https://res.cloudinary.com/djwfw75pg/image/upload/v1762811983/profiteroles_wfzbuh.png" },
                new Dish { DishId = 57, Name = "Chocolate Fondant (Lava Cake)", Description = "Petit gateau com interior cremoso de chocolate derretido; servido quente.", Photo = "https://res.cloudinary.com/djwfw75pg/image/upload/v1762812019/chocolate_fondant_op9vlq.png" },
                new Dish { DishId = 58, Name = "Tarte de Limão", Description = "Tarte de limão com recheio cítrico e massa amanteigada, finalizada com merengue ou creme.", Photo = "https://res.cloudinary.com/djwfw75pg/image/upload/v1762811986/tarte_limao_z0dmhk.png" },
                new Dish { DishId = 59, Name = "Gelato de Baunilha", Description = "Sorvete cremoso de baunilha, textura densa e sabor puro de baunilha.", Photo = "https://res.cloudinary.com/djwfw75pg/image/upload/v1762811984/sorvete_baunilha_z6fmv7.png" },
                new Dish { DishId = 60, Name = "Crème Catalane", Description = "Creme espanhol semelhante ao crème brûlée, coberto por uma crosta de açúcar queimado.", Photo = "https://res.cloudinary.com/djwfw75pg/image/upload/v1762812023/creme_catalane_nlzrb0.png" },
                new Dish { DishId = 61, Name = "Arepa", Description = "Típica da Venezuela e Colômbia, massa de milho grelhada ou frita, geralmente recheada com queijo ou carnes.", Photo = "https://res.cloudinary.com/djwfw75pg/image/upload/v1762812005/arepa_gpwweo.png" },
                new Dish { DishId = 62, Name = "Falafel Wrap", Description = "Bolinho frito de grão-de-bico temperado, servido em pão sírio com tahine e salada.", Photo = "https://res.cloudinary.com/djwfw75pg/image/upload/v1762812023/falafel_wrap_cbip5g.png" },
                new Dish { DishId = 63, Name = "Bánh Mì", Description = "Sanduíche vietnamita em baguete crocante, com carne marinada, vegetais em conserva e ervas frescas.", Photo = "https://res.cloudinary.com/djwfw75pg/image/upload/v1762812004/banh_mi_o6x7zm.png" },
                new Dish { DishId = 64, Name = "Samosa", Description = "Salgado frito típico do Sul da Ásia: massa crocante recheada com batata temperada e ervilhas.", Photo = "https://res.cloudinary.com/djwfw75pg/image/upload/v1762811985/samosa_fezf1o.png" },
                new Dish { DishId = 65, Name = "Pão de Queijo", Description = "Clássico brasileiro em formato de bolinha, leve e borrachudo, feito com polvilho e queijo.", Photo = "https://res.cloudinary.com/djwfw75pg/image/upload/v1762812099/pao_queijo_dzge8p.png" },
                new Dish { DishId = 66, Name = "Empanada Argentina", Description = "Pastel assado ou frito recheado com carne temperada, muito popular como comida de rua na Argentina.", Photo = "https://res.cloudinary.com/djwfw75pg/image/upload/v1762812023/empanada_rrulfv.png" },
                new Dish { DishId = 67, Name = "Shawarma", Description = "Carne temperada fatiada servida em pão sírio com molhos e vegetais - clássico do Oriente Médio.", Photo = "https://res.cloudinary.com/djwfw75pg/image/upload/v1762811984/shawarma_czkxrk.png" },
                new Dish { DishId = 68, Name = "Churros", Description = "Doce frito em massa simples polvilhado com açúcar e canela, frequentemente servido com chocolate.", Photo = "https://res.cloudinary.com/djwfw75pg/image/upload/v1762812017/churros_atcylq.png" },
                new Dish { DishId = 69, Name = "Bao Bun", Description = "Pãozinho chinês cozido no vapor, macio e levemente adocicado, geralmente recheado com carne ou legumes.", Photo = "https://res.cloudinary.com/djwfw75pg/image/upload/v1762812017/churros_atcylq.png" },
                new Dish { DishId = 70, Name = "Pupusa", Description = "Especialidade de El Salvador: tortilla grossa de milho recheada com queijo e feijão, grelhada até dourar.", Photo = "https://res.cloudinary.com/djwfw75pg/image/upload/v1762811982/pupusa_c3npyt.png" },
                new Dish { DishId = 71, Name = "Salada Grega", Description = "Salada fresca e colorida com tomate, pepino, azeitonas e queijo feta, temperada com azeite e orégãos.", Photo = "https://res.cloudinary.com/djwfw75pg/image/upload/v1762811983/salada_grega_abtabf.png" },
                new Dish { DishId = 72, Name = "Shakshuka", Description = "Ensopado de tomates e pimentões com ovos pochê, temperado com alho e especiarias, típico do Mediterrâneo oriental.", Photo = "https://res.cloudinary.com/djwfw75pg/image/upload/v1762811984/shakshuka_t7yvpc.png" },
                new Dish { DishId = 73, Name = "Berinjela Assada com Tahine", Description = "Berinjela grelhada servida com molho de tahine, alho e limão, ótima como entrada ou acompanhamento.", Photo = "https://res.cloudinary.com/djwfw75pg/image/upload/v1762812009/beringela_tahine_enll95.png" },
                new Dish { DishId = 74, Name = "Frango Assado ao Limão e Ervas", Description = "Peito de frango marinado em ervas e limão, assado até ficar dourado e suculento.", Photo = "https://res.cloudinary.com/djwfw75pg/image/upload/v1762812058/frango_limao_ervas_iykwy4.png" },
                new Dish { DishId = 75, Name = "Mexilhões ao Alho e Vinho Branco", Description = "Mexilhões cozidos em caldo aromático de vinho branco, alho e ervas, servidos com pão.", Photo = "https://res.cloudinary.com/djwfw75pg/image/upload/v1762812099/mexilhao_alho_karkll.png" },
                new Dish { DishId = 76, Name = "Hummus com Pão Sírio", Description = "Pastinha cremosa de grão-de-bico e tahine servida com pão sírio aquecido e azeite.", Photo = "https://res.cloudinary.com/djwfw75pg/image/upload/v1762812060/hummus_pao_sirio_hdg5iy.png" },
                new Dish { DishId = 77, Name = "Tapenade de Azeitonas com Baguete", Description = "Patê rústico de azeitonas e alcaparras, perfeito para barrar em fatias de baguete torradas.", Photo = "https://res.cloudinary.com/djwfw75pg/image/upload/v1762811985/tapenade_pdz5hu.png" },
                new Dish { DishId = 78, Name = "Feta Assado com Tomates", Description = "Queijo feta assado com tomates, alho e ervas, servido quente com pão crocante.", Photo = "https://res.cloudinary.com/djwfw75pg/image/upload/v1762812025/feta_assado_pl2dmv.png" },
                new Dish { DishId = 79, Name = "Batatas Gregas ao Limão e Ervas", Description = "Batatas assadas com limão, alho e ervas aromáticas, crocantes por fora e macias por dentro.", Photo = "https://res.cloudinary.com/djwfw75pg/image/upload/v1762812004/batata_grega_nspjgv.png" },
                new Dish { DishId = 80, Name = "Pimentões Recheados com Bulgur", Description = "Pimentões assados recheados com bulgur temperado, tomate, ervas e queijo feta.", Photo = "https://res.cloudinary.com/djwfw75pg/image/upload/v1762811980/pimentao_bulgur_rirqcy.png" },
                new Dish { DishId = 81, Name = "Jollof Rice", Description = "Arroz aromático rico em tomate e especiarias, clássico de vários países da África Ocidental, normalmente servido com carne ou frango.", Photo = "https://res.cloudinary.com/djwfw75pg/image/upload/v1762812060/jollof_ssowuq.png" },
                new Dish { DishId = 82, Name = "Bobotie", Description = "Prato sul-africano assado com carne temperada, camada de ovos e leite formando uma textura cremosa por cima, levemente adocicado com especiarias.", Photo = "https://res.cloudinary.com/djwfw75pg/image/upload/v1762812012/bobotie_hzfmuf.png" },
                new Dish { DishId = 83, Name = "Suya", Description = "Espetinhos de carne secos e bem temperados com mistura de amendoim e especiarias, grelhados até ficarem crocantes nas bordas.", Photo = "https://res.cloudinary.com/djwfw75pg/image/upload/v1762811984/suya_bb9wlh.png" },
                new Dish { DishId = 84, Name = "Tagine de Carne", Description = "Ensopado marroquino de carne e especiarias, cozido lentamente com legumes até o molho ficar concentrado e aromático.", Photo = "https://res.cloudinary.com/djwfw75pg/image/upload/v1762811984/suya_bb9wlh.png" },
                new Dish { DishId = 85, Name = "Poulet Yassa", Description = "Prato senegalês de frango marinado em cebola e limão, lentamente cozido até ficar suculento e com sabor ácido e levemente caramelizado.", Photo = "https://res.cloudinary.com/djwfw75pg/image/upload/v1762811981/poulet_yaza_abzoyb.png" },
                new Dish { DishId = 86, Name = "Piri-Piri Camarão", Description = "Camarões temperados com piri-piri e alho, grelhados rapidamente e servidos com molho picante e limão.", Photo = "https://res.cloudinary.com/djwfw75pg/image/upload/v1762811981/poulet_yaza_abzoyb.png" },
                new Dish { DishId = 87, Name = "Mandazi", Description = "Fritos doces do Leste Africano, semelhantes a donuts leves e aromáticos, perfeitos como lanche ou sobremesa.", Photo = "https://res.cloudinary.com/djwfw75pg/image/upload/v1762812096/mandazi_nj5zbj.png" },
                new Dish { DishId = 88, Name = "Pap (Ugali)", Description = "Papa de farinha de milho (ou fubá) tradicional, acompanhamento simples e reconfortante consumido em várias regiões da África.", Photo = "https://res.cloudinary.com/djwfw75pg/image/upload/v1762812111/pap_ugali_sirz0t.png" },
                new Dish { DishId = 89, Name = "Koshari", Description = "Mistura egípcia de arroz, macarrão e grão-de-bico, servida com molho de tomate picante e cebola crocante por cima.", Photo = "https://res.cloudinary.com/djwfw75pg/image/upload/v1762812089/koshari_hufhow.png" },
                new Dish { DishId = 90, Name = "Bunny Chow", Description = "Pão oco recheado com curry rico e picante — um clássico de Durban com raízes indianas e africanas.", Photo = "https://res.cloudinary.com/djwfw75pg/image/upload/v1762812016/bunny_chow_xbdhb3.png" },
                new Dish { DishId = 91, Name = "Fish and Chips", Description = "Clássico britânico: filé de peixe empanado e frito servido com batatas fritas crocantes e vinagre para acompanhar.", Photo = "https://res.cloudinary.com/djwfw75pg/image/upload/v1762812048/fish_chips_fdmmt3.png" },
                new Dish { DishId = 92, Name = "Doro Wat", Description = "Ensopado etíope de frango com berbere e cebolas caramelizadas, servido tradicionalmente com injera.", Photo = "https://res.cloudinary.com/djwfw75pg/image/upload/v1762812027/doro_wat_ja9qpv.png" },
                new Dish { DishId = 93, Name = "Jerk Chicken", Description = "Frango jamaicano marinado em especiarias e pimenta, grelhado até ficar defumado e aromático.", Photo = "https://res.cloudinary.com/djwfw75pg/image/upload/v1762812060/jerk_chicken_tqk8qa.png" },
                new Dish { DishId = 94, Name = "Khachapuri", Description = "Especialidade georgiana: pão recheado generosamente com queijo derretido e ovo no centro.", Photo = "https://res.cloudinary.com/djwfw75pg/image/upload/v1762812060/khachapuri_c4xn4p.png" },
                new Dish { DishId = 95, Name = "Adobo (Filipinas)", Description = "Carne marinada em vinagre e molho de soja, cozida até ficar macia e rica em sabor; prato essencial filipino.", Photo = "https://res.cloudinary.com/djwfw75pg/image/upload/v1762812003/adobo_crt4nz.png" },
                new Dish { DishId = 96, Name = "Fesenjan", Description = "Ensopado persa rico com nozes e molho de romã, complexo e aveludado, tradicionalmente servido com arroz.", Photo = "https://res.cloudinary.com/djwfw75pg/image/upload/v1762812025/fesenjan_y1gpim.png" },
                new Dish { DishId = 97, Name = "Pierogi", Description = "Bolinho polonês recheado (batata e queijo ou outras variações), cozido e por vezes dourado na manteiga; reconfortante e versátil.", Photo = "https://res.cloudinary.com/djwfw75pg/image/upload/v1762811980/pierogi_llndrr.png" },
                new Dish { DishId = 98, Name = "Poke Bowl", Description = "Tigela havaiana com peixe cru marinado, arroz, algas e acompanhamentos frescos; leve e customizável.", Photo = "https://res.cloudinary.com/djwfw75pg/image/upload/v1762811980/poke_bfadwv.png" },
                new Dish { DishId = 99, Name = "Pastel de Nata", Description = "Doce português: creme de ovos sobre massa folhada crocante, polvilhado levemente com canela e servido quente.", Photo = "https://res.cloudinary.com/djwfw75pg/image/upload/v1762812112/pastel_de_nata_gxhsyf.png" },
                new Dish { DishId = 100, Name = "Fufu com Ensopado de Amendoim", Description = "Papa de mandioca servida com um ensopado rico de amendoim e carne, muito comum em várias cozinhas da África Ocidental.", Photo = "https://res.cloudinary.com/djwfw75pg/image/upload/v1762812058/fufu_amendoim_y16vzv.png" }
            );
